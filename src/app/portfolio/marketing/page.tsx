...
export default function MarketingPortfolio() {
  ...
  const projects = getProjectsByCategory('Marketing Digital');
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 leading-relaxed">
              Découvrez mes stratégies marketing qui génèrent des résultats mesurables et transforment les objectifs en succès.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <Link 
                href="/portfolio"
                className="inline-flex items-center px-6 py-3 text-lg bg-accent-orange/20 text-accent-orange font-medium rounded-xl hover:bg-accent-orange/30 transition-all"
              >
                ← Retour au portfolio
              </Link>
              <button
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-light text-primary mb-4">Mes Projets Marketing</h2>
              <p className="text-xl text-gray-600">Stratégies qui génèrent des résultats</p>
            </div>
              ...
              {projects.map((project, index) => (
                <div key={project.id} className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-2">
                  <div className="relative aspect-[4/3] overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-accent-orange/20 to-accent-red/20 group-hover:from-accent-orange/30 group-hover:to-accent-red/30 transition-all z-10"></div>
                    <div className="absolute inset-0 bg-gradient-to-br from-primary to-primary-dark"></div>
                  </div>
                  
                  <div className="p-8">
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-sm uppercase tracking-wider text-accent-orange bg-accent-orange/10 px-3 py-1 rounded-full">
                        {project.category}
                      </span>
                      {project.duration && (
                    ...
                    {project.technologies && (
                      <div className="mb-6">
                        <h4 className="text-sm font-medium text-gray-700 mb-2">Outils utilisés :</h4>
                    ...
                    <div className="pt-4 border-t border-gray-100">
                      <button className="inline-flex items-center text-sm font-medium text-accent-orange hover:text-accent-red transition-colors">
